...
public class Methods {
	...
	public static String substituteAll(String source, char target, String replacement) {
		...
		// Go through letters, keep adding replacement or the letter on to result
	 ...
	 * Return an array of a given size filled with the provided value
	 * 
	 * @param values an array of integers to find the mean of the length of the returned array
	 * @return a double that is the mean of the array
	 */
